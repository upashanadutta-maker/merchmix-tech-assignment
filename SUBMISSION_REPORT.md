...
![Generated concepts](final_concept_board.png)
...
| --- | --- | --- | --- |
| category | Sweater | Sweater | match |
| colour | blue | blue | match |
| neckline | crew neck | crew neck | match |
| sleeves | straight sleeves | full sleeves | mismatch |
| length | regular | regular | match |
| hem | straight hem | straight hem | match |
| surface | ribbed | ribbed | match |
...
| Feature | Proposed | Observed by reviewer | Check |
| --- | --- | --- | --- |
| category | Trousers | Trousers | match |
| colour | black | black | match |
| leg | wide leg | wide leg | match |
| waist | high waist | high waist | match |
| length | ankle length | full length | mismatch |
| detail | patch pockets | patch pockets | match |
...
| --- | --- | --- | --- |
| category | Sweater | Sweater | match |
| colour | pink | pink | match |
| neckline | boat neck | boat neck | match |
| sleeves | short sleeves | short sleeves | match |
| length | regular | regular | match |
| hem | straight hem | straight hem | match |
| surface | plain | plain | match |
...
Automated comparison: needs_review. Human review: approved.
